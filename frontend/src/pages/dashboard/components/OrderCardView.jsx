...
const statusConfig = {
    ...
    Completed: {
        ...
        badge: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-amber-300'
    },
    Cancelled: {
        icon: XCircle,
        color: 'text-rose-600',
                    ...
                    <div className="flex items-start justify-between">
                        <div className="space-y-1">
                            <div className="flex items-center gap-2">
                                <div className={cn("p-2 rounded-lg", orderType.bgColor)}>
                        ...
                        <Badge variant="secondary" className={cn("font-medium text-xs", status.badge)}>
